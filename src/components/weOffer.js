                ...
                <div className="left">
                    ...
                    <div className="weOfferButtons" >
                        ...
                        <div className="weOfferCard" >
                            <div> <Button value ="b1" style={{ padding: "0" }} onClick={handleChange}> <img className="backCard" src={backgroundCard} />
                                <img className="overlay" src={animationOverlay}  />
                                <p>ANIMATION</p></Button></div>
                        </div>
                        <div className="weOfferCard" value="b2">
                            <div> <Button value="b2" style={{ padding: "0" }} onClick={handleChange}> <img className="backCard" src={backgroundCard} alt="" />
                                <img className="overlay" src={gamesOverlay} />
                                <p>GAMES</p></Button></div>
                        </div>
                        <div className="weOfferCard" value='b3'>
                            <Button value="b3" style={{ padding: "0" }} onClick={handleChange}><img className="backCard" src={backgroundCard} alt="" />
                        ...
                        <div className="weOfferCard" value='b4'>
                            <Button
                                ...
                                value='b4'>
                                <img className="backCard" src={backgroundCard} />
